    ...
    def get(self, request, pk):
        ...
        html += f'''
            ...
            <div class="detail-actions" style="margin-top: 20px; text-align: center;">
                <button
                    onclick="sendWhatsAppBillFromDetail({json.dumps(sale_data)}, {json.dumps({"shopName": profile.shop_name or request.user.get_full_name() or "SubhLabh", "shopAddress": profile.address or "", "shopPhone": profile.phone or ""})})"
        ...
        /* Script removed */ function sendWhatsAppBillFromDetail() {
            let phone = '';
